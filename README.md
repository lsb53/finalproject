...
After entering the estimated clock rates ± 95% HPD into a `.xlsx` [file](https://github.com/lsb53/finalproject/blob/master/Ranavirus%20simulations/BEAST_SimulationOutputs.xlsx), I used R software v4.0.2 (R Core Team 2020) to visualize the data (*ggplot* function, *ggplot2* package; Wickham 2016).
