...
All things considered, this resulted in a total of 24 test combinations (2 taxa sets X 2 nucleotide sequence size sets X 2 root heights X 3 substitution rates). I replicated each combination 5 times, resulting in a total of 120 MCMC analyses of simulated data. Simulations were run for 10 million generations, with subsampling every 1,000 generations.
...
After entering the estimated clock rates ± 95% HPD into a `.xlsx` file, I used R software v4.0.2 (R Core Team 2020) to visualize the data (*ggplot* function, *ggplot2* package; Wickham 2016)
